...
public final class Assertions2 {
    ...
    public static <T> T assertEquals(T expected, ObjectCallable<T> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectCallBuilder().expectation(expected).evaluator(o -> Objects.equals(expected, o)).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertEquals(T expected, T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectBuilder().expectation(expected).evaluator(o -> Objects.equals(expected, o)).build().run(actual).check(context, preCommentSupplier).object();
    }
    ...
    public static boolean assertFalse(ObjectCallable<Boolean> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<Boolean, ?, ?>> preCommentSupplier) {
        return Assertions2.<Boolean>testOfObjectCallBuilder().expectation(false).evaluator(o -> !o).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static boolean assertFalse(boolean actual, Context context, PreCommentSupplier<? super ResultOfObject<Boolean, ?, ?>> preCommentSupplier) {
        return Assertions2.<Boolean>testOfObjectBuilder().expectation(false).evaluator(o -> !o).build().run(actual).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertNotEquals(T unexpected, ObjectCallable<T> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectCallBuilder().expectation(unexpected).evaluator(o -> !Objects.equals(unexpected, o)).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertNotEquals(T unexpected, T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectBuilder().expectation(unexpected).evaluator(o -> !Objects.equals(unexpected, o)).build().run(actual).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertNotNull(ObjectCallable<T> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectCallBuilder().expectation(null).evaluator(Objects::nonNull).build().run(callable).check(context, preCommentSupplier).object();
    }

    public static <T> T assertNotNull(T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectBuilder().expectation(null).evaluator(Objects::nonNull).build().run(actual).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertNotSame(T unexpected, ObjectCallable<T> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectCallBuilder().expectation(unexpected).evaluator(o -> o != unexpected).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertNotSame(T unexpected, T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectBuilder().expectation(unexpected).evaluator(o -> o != unexpected).build().run(actual).check(context, preCommentSupplier).object();
    }

    public static Object assertNull(ObjectCallable<Object> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<Object, ?, ?>> preCommentSupplier) {
        Assertions2.testOfObjectCallBuilder().expectation(null).evaluator(Objects::isNull).build().run(callable).check(context, preCommentSupplier);
        return null;
    }

    public static <T> T assertNull(T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        Assertions2.<T>testOfObjectBuilder().expectation(null).evaluator(Objects::isNull).build().run(actual).check(context, preCommentSupplier);
        return null;
    }
    ...
    public static <T> T assertSame(T expected, ObjectCallable<T> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectCallBuilder().expectation(expected).evaluator(o -> o == expected).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static <T> T assertSame(T expected, T actual, Context context, PreCommentSupplier<? super ResultOfObject<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfObjectBuilder().expectation(expected).evaluator(o -> o == expected).build().run(actual).check(context, preCommentSupplier).object();
    }
    ...
    public static <T extends Throwable> T assertThrows(Class<T> expected, Callable callable, Context context, PreCommentSupplier<? super ResultOfThrowableCall<T, ?, ?>> preCommentSupplier) {
        return Assertions2.<T>testOfThrowableCallBuilder().expectation(expected).evaluator(expected, o -> true).build().run(callable).check(context, preCommentSupplier).throwable();
    }
    ...
    public static boolean assertTrue(ObjectCallable<Boolean> callable, Context context, PreCommentSupplier<? super ResultOfObjectCall<Boolean, ?, ?>> preCommentSupplier) {
        return Assertions2.<Boolean>testOfObjectCallBuilder().expectation(true).evaluator(o -> o).build().run(callable).check(context, preCommentSupplier).object();
    }
    ...
    public static boolean assertTrue(boolean actual, Context context, PreCommentSupplier<? super ResultOfObject<Boolean, ?, ?>> preCommentSupplier) {
        return Assertions2.<Boolean>testOfObjectBuilder().expectation(true).evaluator(o -> o).build().run(actual).check(context, preCommentSupplier).object();
    }

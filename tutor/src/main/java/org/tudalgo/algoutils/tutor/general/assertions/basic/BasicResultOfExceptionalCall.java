...
import org.tudalgo.algoutils.tutor.general.assertions.ResultOfThrowableCall;
...
public class BasicResultOfExceptionalCall<T extends Exception> extends BasicResult<BasicResultOfExceptionalCall<T>, ActualException<T>, BasicTestOfExceptionalCall<T>, ExpectedException<T>> implements ResultOfThrowableCall<T, BasicResultOfExceptionalCall<T>, BasicTestOfExceptionalCall<T>> {
